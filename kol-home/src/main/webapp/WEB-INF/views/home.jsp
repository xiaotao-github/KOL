...
<div class="insert_content" id="insert_div">
    <form id="insert_form" class="layui-form" action="/kol_home/Home/doInsert" method="post" enctype="multipart/form-data">
        <label class="layui-form-label">内容标题</label>
        <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="/kol_home/Home/doInsert" id="insertButton">立即提交</button>
...
<div class="update_content" id="update_slideshow_div" style="display: none">
    <form id="update_form" class="layui-form" enctype="multipart/form-data" action="/kol_home/Home/editing" method="post">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="/kol_home/Home/editing" id="updateButton">立即提交</button>
                <%--<button type="reset" class="layui-btn layui-btn-primary">重置</button>--%>
    ...
    <script>
        ...
        layui.use(["jquery", "upload", "form", "layer", "element"], function () {
            ...
            var uploadInst = upload.render({
                elem: '#headImg'
                , url: '/kol_home/Home/upload/headImg'
                ...
                success: function (r) {
                    ...
                    table.on('tool(home_table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                        ...
                        if(layEvent === 'on_offline'){ //上下线
                            if (data.state==1){//下线操作
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: '/kol_home/Home/offline',
                                    data:{id:id},
                                    success: function (r) {
                                        window.location.href="/kol_home/Home/showPage";
                                    },
                                    error:function () {
                                        alert("失败")
                                    }
                    ...
                    $('#deleteButton').on('click', function() {
                        ...
                        layer.confirm('确定删除id为:'+ids+"这"+data.length+"条数据吗？", {
                            ...
                            window.location.href="/kol_home/Home/delete?id="+ids;
                        }, function(index){
                        });
                    })
                }
