...
<div class="insert_content" id="insert_div" >
    <form id="insert_form" class="layui-form" action="/kol_friends/Message/doInsert" method="post" enctype="multipart/form-data">

        <label class="layui-form-label">消息标题</label>
        <div class="layui-input-inline">
            <input type="text" name="title" class="layui-input" id="title" lay-verify="required">
        </div>
        <br>
        <label class="layui-form-label">副标题</label>
        <div class="layui-input-inline">
            <input type="text" name="subhead" class="layui-input" id="subhead">
        </div>
        <br>
        <label class="layui-form-label">链接</label>
        <div class="layui-input-inline">
            <input type="text" name="url" class="layui-input" id="url"  lay-verify="url">
        </div>
        <br>
        ...
        <div class="layui-input-inline">
            <input type="text" name="editor" class="layui-input" id="editor" lay-verify="required">
        </div>
        <br>
        <label class="layui-form-label">状态</label>
        <div class="layui-input-inline" style="width: 120px">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="/kol_friends/Message/doInsert" id="insertButton">立即提交</button>
...
<div class="update_content" id="update_div" style="display: none">
    ...
    <form id="update_form" class="layui-form" enctype="multipart/form-data" action="/kol_friends/Message/editing" method="post">
        <input type="text" name="id" id="update_id" hidden="hidden">
        <label class="layui-form-label">消息标题</label>
        <div class="layui-input-inline">
            <input type="text" name="title" class="layui-input" id="update_title" lay-verify="required">
        </div>
        <br>
        <label class="layui-form-label">副标题</label>
        <div class="layui-input-inline">
            <input type="text" name="subhead" class="layui-input" id="update_subhead">
        </div>
        <br>
        <label class="layui-form-label">链接</label>
        <div class="layui-input-inline">
            <input type="text" name="url" class="layui-input" id="update_url" lay-verify="url">
        </div>
        <br>
        <%--<label class="layui-form-label">位置</label>
        <div class="layui-input-inline" style="width: 120px">
        ...
        <label class="layui-form-label">发布人</label>
        <div class="layui-input-inline">
            <input type="text" name="editor" class="layui-input" id="update_editor" lay-verify="required">
        </div>
        <br>
        <label class="layui-form-label">状态</label>
        <div class="layui-input-inline" style="width: 120px">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="/kol_friends/Message/editing" id="updateButton">立即提交</button>
                <%--<button type="reset" class="layui-btn layui-btn-primary">重置</button>--%>
    ...
    <script>
        ...
        layui.use(["jquery", "upload", "form", "layer", "element"], function () {
            ...
            var uploadInst = upload.render({
                elem: '#headImg'
                , url: '/kol_friends/Message/upload/headImg'
        ...
        layui.use('table', function () {  // 引入 table模块
            ...
            $.ajax({
                type: "GET",
                url: '/kol_friends/Message/findByProp',
                ...
                success: function (r) {
                    ...
                    table.render({
                        ...
                        , cols: [[ //表头
                            ...
                            , {field: 'subhead', title: '副标题', align: "center"}
                    ...
                    $('#searchButton').click(function () {
                        $.ajax({
                            url: '/kol_friends/Message/findByWords',
                            type: "post",
                            data: $("#searchForm").serialize(),
                            // dataType:'JSON',
                            success: function (r) {
                    ...
                    table.on('tool(friends_table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                        ...
                        if(layEvent === 'on_offline'){ //上线
                            if (data.state==1){//下线操作
                                ...
                                window.location.href="/kol_friends/Message/offline?id="+data.id;
                            }
                            if (data.state==2){
                                alert('ID:'+data.id+'的上线操作');
                                window.location.href="/kol_friends/Message/online?id="+data.id;
                            }
                            ...
                            $("#update_subhead").val(data.subhead);
                    ...
                    $('#deleteButton').on('click', function() {
                        ...
                        layer.confirm('确定删除id为:'+ids+"这"+data.length+"条数据吗？", {
                            ...
                            window.location.href="/kol_friends/Message/delete?id="+ids;
                        }, function(index){
                        });
                    })
                }
    ...
    <script>
        ...
        layui.use('layedit', function(){
            ...
            layedit.set({
                uploadImage: {
                    url: '/kol_friends/Message/upload' //接口url
                    // ,type: '' //默认post
                }
            });
